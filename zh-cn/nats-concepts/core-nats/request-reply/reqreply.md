...
当向一个没有订阅者的主题发送请求时，及时知道这一点可能会很方便。在这种情况下，NATS 客户端可以[选择启用 no\_responder 消息](../../../reference/nats-protocol/nats-protocol/#syntax-1)。这需要服务器和客户端都支持消息头。如果启用此功能，向没有订阅者的主题发送的请求将立即收到一个无正文的回复，且状态码为 `503`。
